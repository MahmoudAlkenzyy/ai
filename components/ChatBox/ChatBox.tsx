...
const ChatBox: React.FC<{ client: string[] }> = ({ client }) => {
  ...
  return (
    <div
      dir="rtl"
      className="bg-white w-full h-full max-h-[12rem] rounded-xl p-6 py-2  mx-auto my-4"
    >
      {/* عنوان المحادثة */}
      ...
      {/* رسالة العميل */}
      <div className="flex flex-col h-2/3 font-bold items-end my-4">
        <div
          ref={scrollableDivRef}
          className=" no-scrollbar  b h-full flex flex-col overflow-y-auto border  border-[#AAECDD] rounded-lg px-4 py w-full ma"
        >
